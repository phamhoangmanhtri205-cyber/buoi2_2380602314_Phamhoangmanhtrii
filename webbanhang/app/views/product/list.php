...
<link href="https://www.google.com/search?q=https://unpkg.com/aos%402.3.1/dist/aos.css" rel="stylesheet">
<script src="https://www.google.com/search?q=https://unpkg.com/aos%402.3.1/dist/aos.js"></script>
...
<div class="container d-flex justify-content-between align-items-center">
<a href="/tri/webbanhang/Product/list" class="brand-logo">NEYMAR<span>SPORT</span></a>
...
DANH MỤC
<!-- NÚT THÊM DANH MỤC -->
<a href="/tri/webbanhang/Category/add" class="btn btn-xs btn-dark rounded-circle" title="Thêm danh mục">
<i class="fas fa-plus" style="font-size: 10px;"></i>
</a>
</div>

            <ul class="category-list">
                <!-- Bạn nên dùng foreach $categories ở đây -->
                <?php 
                // Demo list danh mục, trong thực tế hãy dùng foreach ($categories as $cat)
                $demo_cats = ["Giày Đá Banh Nike", "Giày Đá Banh Adidas", "Giày Đá Banh Puma", "Phụ Kiện Thể Thao"];
                ...
                <li class="category-item">
                    ...
                    <div class="category-actions">
                        <a href="/tri/webbanhang/Category/edit/1" class="text-primary" title="Sửa"><i class="fas fa-edit"></i></a>
                        <a href="/tri/webbanhang/Category/delete/1" class="text-danger" title="Xóa" onclick="return confirm('Xóa danh mục này?')"><i class="fas fa-trash"></i></a>
                    </div>
                </li>
                <?php endforeach; ?>
            </ul>
    ...
    <div class="col-lg-9">
        <div class="d-flex justify-content-between align-items-center mb-4 pb-2 border-bottom" data-aos="fade-left">
            <div class="d-flex align-items-center">
                ...
                <!-- NÚT THÊM SẢN PHẨM -->
                <a href="/tri/webbanhang/Product/add" class="btn btn-dark btn-sm rounded-0 fw-bold px-3">
                ...
                <div class="card h-100 product-card shadow-sm">
                    <div class="image-wrapper">
                        ...
                        <div class="admin-float-actions">
                            <a href="/tri/webbanhang/Product/edit/<?= $product->id ?>" class="btn-admin-icon" title="Sửa sản phẩm">
                                <i class="fas fa-pen"></i>
                            </a>
                            <a href="/tri/webbanhang/Product/delete/<?= $product->id ?>" 
                        ...
                        <img src="/tri/webbanhang/<?= !empty($product->image) ? $product->image : 'assets/no-image.jpg' ?>" 
                        ...
                        <div class="shopping-overlay">
                            ...
                            <a href="#" class="btn btn-action btn-cart fw-bold py-2 shadow-lg">THÊM GIỎ HÀNG</a>
                            <a href="/tri/webbanhang/Product/show/<?= $product->id ?>" class="btn btn-action btn-detail fw-bold py-2">XEM CHI TIẾT</a>
                        </div>
                    </div>

                    <div class="card-body p-3 text-center">
                        <p class="text-muted small mb-1 uppercase letter-spacing-1">Giày Đá Banh Chính Hãng</p>
                        <a href="/tri/webbanhang/Product/show/<?= $product->id ?>" class="product-name fw-bold text-dark text-decoration-none fs-6">
...
<div class="mt-3">
<img src="https://www.google.com/search?q=https://neymarsport.com/cdn/shop/files/da-dang-ky-bo-cong-thuong_large.png%3Fv%3D1614324321" width="150" alt="BCT">
</div>
</div>
</div>
